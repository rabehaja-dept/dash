import type { Metadata, EntitySys, FieldsType } from "contentful";
...
import { CONTENTFUL_BASE_URL, CONTENTFUL_ALGOLIA_INDEX } from "~/lib/consts";
...
function Hit({ hit }: HitProps) {
  return (
    <Link href={`${CONTENTFUL_BASE_URL}/posts/${hit.fields.slug}`}>
      <Highlight hit={hit} attribute="fields" />
      <span>{hit.fields.title}</span>
    </Link>
  );
}
  ...
  return (
    <InstantSearchSSRProvider {...serverState}>
      ...
      >
        ...
        <InstantSearch
          searchClient={client}
          indexName={CONTENTFUL_ALGOLIA_INDEX}
          routing={{
