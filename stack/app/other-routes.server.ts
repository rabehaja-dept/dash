...
import { getSitemapXml } from "~/seo/sitemap.server";
...
function doesRouteExistOnSiteMap(path: string) {
  return pathedRoutes[path];
}

export { routes, pathedRoutes, doesRouteExistOnSiteMap };
